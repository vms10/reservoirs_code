...
def keep_bounded(dataset_func, max_trials=100, threshold=1e5):    
    ...
    def stable_dataset(n_samples=10, sample_len=1000,freq=0.01,amp=0.9,phase=100, noise=0,train="BD"):
...
@keep_bounded
def ga4(n_samples=10, sample_len=1000,freq=0.01,amp=0.9,phase=100,noise=0,train = "BD"):
